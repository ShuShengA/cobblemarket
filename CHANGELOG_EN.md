...
- **Balance HUD still showed on top of vanilla screens**: it stayed over the pause menu, the options screens and the inventory (in the way when taking screenshots or recording), and over other mods' screens too; it is now drawn only on **this mod's own screens** (still visible in the bid / purchase dialogs) — vanilla screens and other mods' screens no longer show it
